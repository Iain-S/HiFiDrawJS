...
function addSampleData(tableObj, redrawFunc, visNetwork) {
    ...
    const pc_dac_amp_speakers =
        "{\"nodes\":[" +
            ...
            "{\"id\":\"speaker (left)\",\"label\":\"speaker (left)\",\"shape\":\"box\",\"x\":-199,\"y\":68}," +
            "{\"id\":\"speaker (right)\",\"label\":\"speaker (right)\",\"shape\":\"box\",\"x\":59,\"y\":66}]," +
        "\"edges\":[" +
            "{\"from\":\"dac\",\"to\":\"amplifier\",\"arrows\":\"to\",\"label\":\"rca-rca\"}," +
            "{\"from\":\"amplifier\",\"to\":\"speaker (left)\",\"arrows\":\"to\",\"label\":\"speaker cable\"}," +
            "{\"from\":\"pc\",\"to\":\"dac\",\"arrows\":\"to\",\"label\":\"usb\"}," +
            "{\"from\":\"amplifier\",\"to\":\"speaker (right)\",\"arrows\":\"to\",\"label\":\"speaker cable\"}]}";
